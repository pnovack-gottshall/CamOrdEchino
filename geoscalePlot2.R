...
## 2020 timescale. Code by Mark Bell and taken from
## https://github.com/cran/geoscale/blob/master/R/geoscalePlot.R. Thanks, Mark!

geoscalePlot2 <- function (ages, data, units = c("Age", "Epoch", "Period"),
            tick.scale = "myr", boxes = "Age", abbrev, cex.age = 0.3,
            cex.ts = 0.4, cex.pt = 1, age.lim = NULL, data.lim = NULL, 
            user.scale, ts.col = TRUE, ts.width = 0.3, label, timescale = NULL,
            no.axis = FALSE, direction = "horizontal", erotate, arotate,
            urotate, ...)
  {
